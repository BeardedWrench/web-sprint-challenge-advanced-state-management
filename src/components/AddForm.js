...
import { addSmurf, newError } from '../actions';
...
const AddForm = ( props ) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            props.newError( "Name, position and nickname fields are required." );
        }else{
...
export default connect( mapStateToProps, { addSmurf, newError })( AddForm );
